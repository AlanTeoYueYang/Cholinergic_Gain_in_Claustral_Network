function [Wsoc,temp] = soc_function_revised(W_initial, rate, desired_SA, gamma, end_exc)
...
while e(i) > desired_SA
    ...
    if mod(i,20) == 0 %Plot spectrum of Wsoc every 20 iterations
        ...
        e(i)    %Print the current maximum real eigenvalue
        pause(0.01)
...
thres = round(0.5*length(inh_weights));
